...
import { ArrowRight, Train, MapPin } from "@lucide/vue"
...
<template>
  <div class="mx-auto max-w-3xl px-4 py-8">
    <div class="mb-6">
      <Link :href="home.url()" class="text-muted-foreground hover:text-primary mb-2 inline-flex items-center gap-1 text-sm">
    ...
    <div v-if="jadwals.length === 0" class="py-16 text-center">
    ...
    <div v-else class="space-y-4">
      <Card v-for="jadwal in jadwals" :key="jadwal.id_jadwal">
